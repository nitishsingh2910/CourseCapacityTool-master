...
//	private int departmentId;
	...
	public String getTimeAtSyracuse() {
		return timeAtSyracuse;
	}

	public void setTimeAtSyracuse(String timeAtSyracuse) {
		this.timeAtSyracuse = timeAtSyracuse;
	}
    ...
    @Column(name="time_at_syracuse" , length=255)
	private String timeAtSyracuse;
