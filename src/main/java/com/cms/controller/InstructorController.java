...
//		
	...
	public String saveInstructorProfile(@RequestParam(value = "id", required = false) Integer id,@ModelAttribute Instructor instructor , BindingResult binding , HttpServletRequest request ){
		System.out.println("save instrcutor profile");
		instructorService.createInstructor(instructor);
		if(instructor.getFile() != null) {
		 //upload the file
...
//	@PostMapping("/instructor-profile-saved/{id}")
//	public String updateInstructorProfile(@PathVariable("id") int id, @ModelAttribute Instructor instructor , BindingResult binding , HttpServletRequest request ){
//		instructorService.createInstructor(instructor);
//		if(instructor.getFile() != null) {
//			//upload the file
//			if(!instructor.getFile().getOriginalFilename().equals("") ){
